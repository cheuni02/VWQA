@Daily @vw-plugin-cps-vw-section-about-us @wip
Feature: Contact Us Email Form
  ...
  Background: Visitng the Contact Us Email Page
    Given i am on the Contact Us section of the website

  Scenario Outline: Completing the email form with data
    Given i select options to reveal the contact us form
  ...
  Scenario: Testing Retailer Find by location
   Given i select contact options to show the retailer find by location section
